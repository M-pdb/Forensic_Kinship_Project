...
# The 50,000 .ped files from the HS_Linked simulation are manipulated to simulate unrelated individuals.
# This is done by:
...
# Set the directories, input directory is where the HS_Linked simulated .peds are stored and the output directory is where the manipulated .peds will be stored
in_dir  <- "/scratch/users/k21040223/HS_Simulation/HS_Linked"
out_dir <- "/scratch/users/k21040223/HS_Simulation/HS_Linked_Unrelated"
...
$ nano HS_Linked_Manipulation_Array.sh

!/bin/bash
#SBATCH --job-name=HS_Linked_Manipulation_Array
#SBATCH --array=0-99
#SBATCH --output=HS_Linked_Manipulation_Array_%a.out
#SBATCH --error=HS_Linked_Manipulation_Array_%a.err
...
$(which Rscript) HS_Linked_Manipulation.R $START $END

# Submit the job to SLURM
$ sbatch HS_Linked_Manipulation_Array.sh
```
...
```{r}
# Define file paths
Manipulated_HS_Ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/HS_Simulation/HS_Linked_Unrelated/merlin-00003898-00001-replicate_UN.ped"

# Load the Linked file
Manipulated_HS_Ped1 <- read_delim(Manipulated_HS_Ped1_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(Manipulated_HS_Ped1)
```
...
```{r}
# Define file paths
HS_Linked_ped2_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/HS_Simulation/HS_Linked/merlin-00003898-00002-replicate.ped"

# Load the Linked file
HS_Linked_ped2 <- read_delim(HS_Linked_ped2_path, delim = "\t", col_names = FALSE)
...
```{r}
# Define file paths
Manipulated_HS_Ped2_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/HS_Simulation/HS_Linked_Unrelated/merlin-00003898-00002-replicate_UN.ped"

# Load the Linked file
Manipulated_HS_Ped2 <- read_delim(Manipulated_HS_Ped2_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(Manipulated_HS_Ped2)
```
...
```{r}
# Define file paths
HS_Linked_ped36792_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/HS_Simulation/HS_Linked/merlin-00003898-36792-replicate.ped"

# Load the Linked file
HS_Linked_ped36792 <- read_delim(HS_Linked_ped36792_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(HS_Linked_ped36792)
```
...
```{r}
# Define file paths
Manipulated_HS_Ped36792_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/HS_Simulation/HS_Linked_Unrelated/merlin-00003898-36792-replicate_UN.ped"

# Load the Linked file
Manipulated_HS_Ped36792 <- read_delim(Manipulated_HS_Ped36792_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(Manipulated_HS_Ped36792)
```

# Run MERLIN to extract lnLikelihoods for unrelated cases
# Note: We are not re-simulating — genotypes must remain consistent between HS_Linked and HS_Linked_Unrelated.
...
$ nano HS_Linked_Unrelated.sh

#!/bin/bash
#SBATCH --job-name=merlin_HS_Linked_Unrelated
#SBATCH --output=merlin_HS_Linked_Unrelated.out
#SBATCH --error=merlin_HS_Linked_Unrelated.err
#SBATCH --ntasks=1
...
PED_DIR="$BASE_DIR/HS_Linked_Unrelated"
OUTPUT_DIR="$BASE_DIR/HS_Linked_Unrelated"
...
OUTFILE="$OUTPUT_DIR/HS_Linked_Unrelated_lnlikelihoods.txt"
echo -e "replicate\ttotal_lnlikelihood" > "$OUTFILE"

# Create folder for storing individual lnLikelihood output files
LNLIKELIHOOD_DIR="$OUTPUT_DIR/HS_Linked_Unrelated_lnlikelihoods"
