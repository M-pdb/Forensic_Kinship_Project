...
# Output lnLikelihoods are generated for each replicate in the HS_Linked .ped dataset
...
#!/bin/bash
#SBATCH --job-name=merlin_HS_Unlinked
#SBATCH --output=merlin_HS_Unlinked.out
#SBATCH --error=merlin_HS_Unlinked.err
#SBATCH --ntasks=1
...
PED_DIR="$BASE_DIR/HS_Linked"
OUTPUT_DIR="$BASE_DIR/HS_Unlinked"
...
$ sbatch HS_Unlinked.sh
```

# NOTE:
# The HS_Linked_Unrelated and HS_Unlinked_Unrelated conditions both represent two unrelated individuals with no pedigree structure.
...
# To save computational time, ln-likelihoods were only calculated once (for HS_Linked_Unrelated) and reused for HS_Unlinked_Unrelated where applicable.
