...
```{r}
# Define file paths
HS_Linked_ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship_Project/10,000_SNPs/HS_Simulation/Input_Files/HS_10000.ped"
...
# The SLURM batch script (merlin_HS_Linked.sh) is configured to simulate 50,000 replicates 
...
$ nano merlin_HS_Linked.sh

#!/bin/bash

# SLURM job settings
#SBATCH --job-name=merlin_HS_Linked
#SBATCH --output=merlin_HS_Linked.out
#SBATCH --error=merlin_HS_Linked.err
#SBATCH --ntasks=1
...
cd /scratch/users/k21040223/HS_Simulation/HS_Linked

# Simulate MERLIN
merlin -p ../Original_Files/HS_10000.ped -d ../Original_Files/Updated_Kintelligence.dat -m ../Original_Files/Updated_Kintelligence_Map_noX.map -f ../Original_Files/Kintelligence_British_10000.freq -r 3898 --simulate --reruns 50000 --likelihood --information --markerNames --quiet --save --prefix HS_Linked/HS_Linked > likelihoods_HS_Linked_summary.txt

# Submit job to HPC
$ sbatch merlin_HS_Linked.sh
```
...
INFILE="/scratch/users/k21040223/HS_Simulation/HS_Linked/likelihoods_HS_Linked_summary.txt"
OUTFILE="/scratch/users/k21040223/HS_Simulation/HS_Linked/HS_Linked_lnlikelihoods.txt"
...
```{r}
# Define file paths
HS_Linked_ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship_Project/10,000_SNPs/HS_Simulation/HS_Linked/merlin-00003898-00001-replicate.ped"

# Load the Linked file
HS_Linked_ped1 <- read_delim(HS_Linked_ped1_path, delim = "\t", col_names = FALSE)
