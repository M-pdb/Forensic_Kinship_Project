...
```{r}
# Define file paths
FS_Linked_ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship_Project/10,000_SNPs/FS_Simulation/Input_Files/FS_10000.ped"
...
# The SLURM batch script (merlin_FS_Linked.sh) is configured to simulate 50,000 replicates 
...
$ nano merlin_FS_Linked.sh

#!/bin/bash

# SLURM job settings
#SBATCH --job-name=merlin_FS_Linked
#SBATCH --output=merlin_FS_Linked.out
#SBATCH --error=merlin_FS_Linked.err
#SBATCH --ntasks=1
...
cd /scratch/users/k21040223/FS_Simulation/FS_Linked

# Simulate MERLIN
merlin -p ../Original_Files/FS_10000.ped -d ../Original_Files/Updated_Kintelligence.dat -m ../Original_Files/Updated_Kintelligence_Map_noX.map -f ../Original_Files/Kintelligence_British_10000.freq -r 3898 --simulate --reruns 50000 --likelihood --information --markerNames --quiet --save --prefix FS_Linked/FS_Linked > likelihoods_FS_Linked_summary.txt

# Submit job to HPC
$ sbatch merlin_FS_Linked.sh
```
...
INFILE="/scratch/users/k21040223/FS_Simulation/FS_Linked/likelihoods_FS_Linked_summary.txt"
OUTFILE="/scratch/users/k21040223/FS_Simulation/FS_Linked/FS_Linked_lnlikelihoods.txt"
...
```{r}
# Define file paths
FS_Linked_ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship_Project/10,000_SNPs/FS_Simulation/FS_Linked/merlin-00003898-00001-replicate.ped"

# Load the Linked file
FS_Linked_ped1 <- read_delim(FS_Linked_ped1_path, delim = "\t", col_names = FALSE)
