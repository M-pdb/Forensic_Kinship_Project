...
# Output lnLikelihoods are generated for each replicate in the FS_Linked .ped dataset
...
#!/bin/bash
#SBATCH --job-name=merlin_FS_Unlinked
#SBATCH --output=merlin_FS_Unlinked.out
#SBATCH --error=merlin_FS_Unlinked.err
#SBATCH --ntasks=1
...
PED_DIR="$BASE_DIR/FS_Linked"
OUTPUT_DIR="$BASE_DIR/FS_Unlinked"
...
$ sbatch FS_Unlinked.sh
```

# NOTE:
# The FS_Linked_Unrelated and FS_Unlinked_Unrelated conditions both represent two unrelated individuals with no pedigree structure.
...
# To save computational time, ln-likelihoods were only calculated once (for FS_Linked_Unrelated) and reused for FS_Unlinked_Unrelated where applicable.
