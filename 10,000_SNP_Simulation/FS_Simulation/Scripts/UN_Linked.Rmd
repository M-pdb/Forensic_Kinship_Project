...
```{r}
# Define file paths
FS_Linked_ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/FS_Simulation/Input_Files/FS_10000.ped"

# Load the Linked file
Original_FS_ped <- read_delim(FS_Linked_ped1_path, delim = "\t", col_names = FALSE)
...
write_delim(
  Unrelated_FS_ped,
  "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/FS_Simulation/Input_Files/FS_10000_UN.ped",
  delim = "\t",
  col_names = FALSE
)
...
```{r}
# Define file paths
UN_Linked_ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/FS_Simulation/UN_Linked/merlin-00003898-00001-replicate.ped"
...
input_dir  <- "/scratch/users/k21040223/FS_Simulation/UN_Linked"
output_dir <- "/scratch/users/k21040223/FS_Simulation/UN_Linked"
orig_ped   <- "/scratch/users/k21040223/FS_Simulation/Original_Files/FS_10000.ped"
n_reps     <- 50000
...
# Drop row 5 and column 9997 from the simulated file
...
```{r}
# Define file paths
Simulated_UN_ped1_modified_path <- "/Users/huncho/Desktop/Forensic_Kinship/10,000_SNP_Simulation/FS_Simulation/UN_Linked/UN_ped_00001-fixed.ped"
