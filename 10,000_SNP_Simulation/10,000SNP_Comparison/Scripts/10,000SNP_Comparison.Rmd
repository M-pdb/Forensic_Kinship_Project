...
p_full <- ggplot(plot_data_fc, aes(x = log10LR, fill = Group, colour = Group)) +
  ...
  labs(
    title = "Independent Replication: FC vs UN – Full log10LR Distribution (9991 SNPs)",
    x = "log10LR", y = "Density"
  ) +
  theme_minimal() +
...
p_capped <- p_full +
  ...
  labs(title = "Independent Replication: FC vs UN – Capped log10LR Distribution (9991 SNPs)")
...
p_full <- ggplot(plot_data_hs, aes(x = log10LR, fill = Group, colour = Group)) +
  ...
  geom_vline(xintercept = 0, linetype = "dashed") +
  labs(
    title = "Independent Replication: HS vs UN – Full log10LR Distribution (9991 SNPs)",
    x = "log10LR", y = "Density"
  ) +
  theme_minimal() +
  theme(legend.title = element_blank(), legend.position = "right")
...
p_capped <- p_full +
  ...
  labs(title = "Independent Replication: HS vs UN – Capped log10LR Distribution (9991 SNPs)")
