...
# Output lnLikelihoods are generated for each replicate in the HS_Linked_Unrelated .ped dataset

```{bash}
$ nano HS_Unlinked_Unrelated.sh
...
OUTPUT_DIR="$BASE_DIR/HS_Unlinked_Unrelated"
...
OUTFILE="$OUTPUT_DIR/HS_Unlinked_Unrelated_lnlikelihoods.txt"
echo -e "replicate\tlnlikelihood" > "$OUTFILE"

# Create folder for storing individual lnLikelihood output files
LNLIKELIHOOD_DIR="$OUTPUT_DIR/HS_Unlinked_Unrelated_lnlikelihoods"
...
chmod +x HS_Unlinked_Unrelated.sh
./HS_Unlinked_Unrelated.sh
```