...
in_dir  <- "/Users/huncho/Desktop/Forensic_Kinship_Project/HS_Simulation/HS_Linked"
out_dir <- "/Users/huncho/Desktop/Forensic_Kinship_Project/HS_Simulation/HS_Linked_Unrelated"

# Create the output directory if it doesn’t exist
if (!dir.exists(out_dir)) dir.create(out_dir)

# Grab all HS_Linked .ped files matching the pattern:
...
```{r}
# Define file paths
Manipulated_HS_Ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/HS_Simulation/HS_Linked_Unrelated/merlin-00003898-00001-replicate_UN.ped"
...
```{r}
# Define file paths
Simulated_HS_Ped27674_path <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/HS_Simulation/HS_Linked/merlin-00003898-27674-replicate.ped"

# Load the Linked file
Simulated_HS_Ped27674 <- read_delim(Simulated_HS_Ped27674_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(Simulated_HS_Ped27674)
```
...
```{r}
# Define file paths
Manipulated_HS_Ped27674_path <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/HS_Simulation/HS_Linked_Unrelated/merlin-00003898-27674-replicate_UN.ped"

# Load the Linked file
Manipulated_HS_Ped27674 <- read_delim(Manipulated_HS_Ped27674_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(Manipulated_HS_Ped27674)
```
...
chmod +x HS_Linked_Unrelated.sh
./HS_Linked_Unrelated.sh
```
