...
write_delim(
  Unrelated_FC_ped,
  "/Users/huncho/Desktop/Forensic_Kinship_Project/FC_Simulation/Original_Files/FCvUN_94_UN.ped",
  delim = "\t",
  col_names = FALSE
)
...
```{bash}
merlin -p ../Original_Files/FCvUN_94_UN.ped -d ../Original_Files/Markers_ForenSeq_SNP.dat -m ../Original_Files/Linked_ForenSeqSNP.map -f ../Original_Files/WBFreq_94_SNPs_FamLink.freq -r 3898 --simulate --reruns 50000 --likelihood --information --markerNames --quiet --save --prefix UN_Linked/UN_Linked > likelihoods_UN_Linked_summary.txt
```
...
```{r}
# Define file paths
Simulated_UN_Ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/FC_Simulation/UN_Linked/merlin-00003898-00001-replicate.ped"
...
input_dir  <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/FC_Simulation/UN_Linked/"       
output_dir <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/FC_Simulation/UN_Linked/"       
orig_ped   <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/FC_Simulation/Input_Files/FCvUN_94.ped"
...
for(i in seq_len(n_reps)) {
  ...
  # Drop row 9 and column 100 from the simulated file
