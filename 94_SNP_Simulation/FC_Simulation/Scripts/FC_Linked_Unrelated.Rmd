...
in_dir  <- "/Users/huncho/Desktop/Forensic_Kinship_Project/FC_Simulation/FC_Linked"
out_dir <- "/Users/huncho/Desktop/Forensic_Kinship_Project/FC_Simulation/FC_Linked_Unrelated"

# Create the output directory if it doesn’t exist
if (!dir.exists(out_dir)) dir.create(out_dir)

# Grab all FC_Linked .ped files matching the pattern:
...
```{r}
# Define file paths
Manipulated_FC_Ped1_path <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/FC_Simulation/FC_Linked_Unrelated/merlin-00003898-00001-replicate_UN.ped"
...
```{r}
# Define file paths
Simulated_FC_Ped27674_path <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/FC_Simulation/FC_Linked/merlin-00003898-27674-replicate.ped"

# Load the Linked file
Simulated_FC_Ped27674 <- read_delim(Simulated_FC_Ped27674_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(Simulated_FC_Ped27674)
```
...
```{r}
# Define file paths
Manipulated_FC_Ped27674_path <- "/Users/huncho/Desktop/Forensic_Kinship/94_SNP_Simulation/FC_Simulation/FC_Linked_Unrelated/merlin-00003898-27674-replicate_UN.ped"

# Load the Linked file
Manipulated_FC_Ped27674 <- read_delim(Manipulated_FC_Ped27674_path, delim = "\t", col_names = FALSE)

# Display structure of the files
View(Manipulated_FC_Ped27674)
```
...
chmod +x FC_Linked_Unrelated.sh
./FC_Linked_Unrelated.sh
```
