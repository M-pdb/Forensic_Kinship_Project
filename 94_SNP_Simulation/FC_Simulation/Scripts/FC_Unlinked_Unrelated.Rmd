...
# Output lnLikelihoods are generated for each replicate in the FC_Linked_Unrelated .ped dataset

```{bash}
$ nano FC_Unlinked_Unrelated.sh
...
OUTPUT_DIR="$BASE_DIR/FC_Unlinked_Unrelated"
...
OUTFILE="$OUTPUT_DIR/FC_Unlinked_Unrelated_lnlikelihoods.txt"
echo -e "replicate\tlnlikelihood" > "$OUTFILE"

# Create folder for storing individual lnLikelihood output files
LNLIKELIHOOD_DIR="$OUTPUT_DIR/FC_Unlinked_Unrelated_lnlikelihoods"
...
chmod +x FC_Unlinked_Unrelated.sh
./FC_Unlinked_Unrelated.sh
```