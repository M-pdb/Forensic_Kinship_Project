...
# Output lnLikelihoods are generated for each replicate in the UN_Linked_Unrelated .ped dataset

```{bash}
$ nano UN_Unlinked_Unrelated.sh
...
OUTPUT_DIR="$BASE_DIR/UN_Unlinked_Unrelated"
...
OUTFILE="$OUTPUT_DIR/UN_Unlinked_Unrelated_lnlikelihoods.txt"
echo -e "replicate\tlnlikelihood" > "$OUTFILE"

# Create folder for storing individual lnLikelihood output files
LNLIKELIHOOD_DIR="$OUTPUT_DIR/UN_Unlinked_Unrelated_lnlikelihoods"
...
chmod +x UN_Unlinked_Unrelated.sh
./UN_Unlinked_Unrelated.sh
```