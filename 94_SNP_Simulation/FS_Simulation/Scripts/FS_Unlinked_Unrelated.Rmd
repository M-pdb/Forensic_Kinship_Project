...
# Output lnLikelihoods are generated for each replicate in the FS_Linked_Unrelated .ped dataset

```{bash}
$ nano FS_Unlinked_Unrelated.sh
...
chmod +x FS_Unlinked_Unrelated.sh
./FS_Unlinked_Unrelated.sh
```